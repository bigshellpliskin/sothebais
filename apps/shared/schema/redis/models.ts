...
export interface AuctionSessionState {
  ...
  streamKey?: string;
  currentLotId?: string;
  lotIds: string[]; // Ordered list of lot IDs
  currentLotIndex: number; // Index of the current lot in the lotIds array
}

// Lot (Auction) State Models
export interface AuctionState {
  ...
  highestBidId?: string;
  lotOrder: number; // Order in the session
}
